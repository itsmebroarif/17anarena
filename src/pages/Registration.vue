<template>
  <div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="bg-gradient-to-r from-red-600 via-rose-600 to-red-700 text-white rounded-3xl p-6 sm:p-8 shadow-xl shadow-red-200/50 relative overflow-hidden">
      ...
      <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-1.5 bg-black/30 p-1.5 rounded-2xl border border-white/20 backdrop-blur-md self-start md:self-auto">
          ...
          <!-- Paper Template Print & PDF Backup Button -->
          <button
            @click="isBojongLioModalOpen = true"
            class="px-3.5 py-2 rounded-xl text-xs font-extrabold transition-all flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-700 text-white shadow-md border border-indigo-400"
          >
            <i class="bi bi-file-earmark-pdf-fill text-amber-300"></i>
            <span>Form A4 Bojong Lio & WA</span>
          </button>

          <button
            @click="isPaperModalOpen = true"
            class="px-3.5 py-2 rounded-xl text-xs font-extrabold transition-all flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white shadow-md border border-blue-400"
          >
            <i class="bi bi-printer-fill text-amber-300"></i>
            <span>Paper Template (PDF/A4)</span>
          </button>
        </div>
      </div>
    </div>
            ...
            <div class="lg:col-span-7 space-y-5">
              ...
              <div class="bg-slate-50/80 p-5 rounded-2xl border border-slate-200/80 space-y-4">
                ...
                <div class="space-y-4">
                  ...
                  <!-- Umur, Kategori Tingkat & Gender Grid -->
                  <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                      <div class="flex items-center mb-1">
                        ...
                        <QuickHelpTooltip
                          title="Petunjuk Umur"
                          content="Digunakan untuk memvalidasi kategori lomba."
                          example="10"
                          position="top"
                        />
                      </div>
                    ...
                    <div>
                      <div class="flex items-center mb-1">
                        <label class="block text-xs font-bold text-slate-700">Kategori & Tingkat <span class="text-red-600">*</span></label>
                        <QuickHelpTooltip
                          title="Tingkat Kategori"
                          content="Anak-anak: TK & SD (Kelas 1-6), Remaja: SMP & SMA, Dewasa: Dewasa."
                          position="top"
                        />
                      </div>
                      <select
                        v-model="participantForm.categoryLevel"
                        class="w-full px-3 py-2.5 border border-slate-300 bg-white text-slate-900 rounded-xl text-xs font-bold focus:ring-2 focus:ring-red-500/50 focus:outline-none"
                      >
                    ...
                    <div>
                      ...
                      <div class="grid grid-cols-2 gap-2 mt-1">
                        <label
                          class="flex items-center justify-center py-2.5 px-2 rounded-xl border text-xs font-bold cursor-pointer transition-colors"
            ...
            <table class="w-full text-left text-xs min-w-[700px]">
              <thead class="bg-slate-100 text-slate-600 font-bold uppercase border-b border-slate-200">
                <tr>
                  ...
                  <th class="p-3 min-w-[180px]">Nama Lengkap Peserta *</th>
                  <th class="p-3 w-20">Umur *</th>
                  <th class="p-3 min-w-[160px]">Kategori & Tingkat *</th>
                  <th class="p-3 w-28">Gender *</th>
                  <th class="p-3 min-w-[130px]">WhatsApp (Opsional)</th>
                  <th class="p-3 min-w-[140px]">Alamat / RT RW (Opsional)</th>
              ...
              <tbody class="divide-y divide-slate-100">
                ...
                >
                  ...
                  <td class="p-2">
                    <select
                      v-model="row.categoryLevel"
                      class="w-full px-2 py-1.5 border border-slate-300 rounded-lg text-xs font-bold text-slate-800 focus:outline-none bg-white"
                    >
                      <optgroup label="👶 Anak-anak (TK & SD)">
                        <option value="Anak-anak (TK)">TK</option>
                        <option value="Anak-anak (SD Kelas 1)">SD Kelas 1</option>
                        <option value="Anak-anak (SD Kelas 2)">SD Kelas 2</option>
                        <option value="Anak-anak (SD Kelas 3)">SD Kelas 3</option>
                        <option value="Anak-anak (SD Kelas 4)">SD Kelas 4</option>
                        <option value="Anak-anak (SD Kelas 5)">SD Kelas 5</option>
                        <option value="Anak-anak (SD Kelas 6)">SD Kelas 6</option>
                      </optgroup>
                      <optgroup label="👦 Remaja (SMP & SMA)">
                        <option value="Remaja (SMP)">Remaja (SMP)</option>
                        <option value="Remaja (SMA)">Remaja (SMA)</option>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
      <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-3 border-b border-slate-100 pb-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
          ...
          <button
            @click="isPaperModalOpen = true"
            class="px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white font-extrabold text-xs rounded-xl shadow-xs transition-colors flex items-center gap-1.5"
            title="Buka Paper Template Pendaftaran A4 / Backup PDF"
          >
            <i class="bi bi-file-earmark-pdf-fill"></i>
            <span>Paper Template Bulking (PDF)</span>
          </button>
        ...
        <table class="w-full text-left text-xs">
          <thead class="bg-slate-100 text-slate-600 uppercase font-bold">
            <tr>
              ...
              <th class="p-3 w-28 text-center">Aksi (Edit/Hapus)</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-slate-100">
            <tr
              ...
              <td class="p-3 text-center">
                <div class="flex items-center justify-center space-x-1.5">
                  <button
                    ...
                    class="p-1.5 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-lg font-bold text-xs transition-colors border border-blue-200 flex items-center gap-1"
                    title="Edit Data Peserta Ini"
                  >
                  ...
                  <button
                    ...
                    class="p-1.5 bg-rose-50 text-rose-700 hover:bg-rose-100 rounded-lg font-bold text-xs transition-colors border border-rose-200 flex items-center gap-1"
    ...
    <!-- Bojong Lio A4 Form & WA Modal -->
    <BojongLioPrintWaModal
      :is-open="isBojongLioModalOpen"
      @close="isBojongLioModalOpen = false"
    />
  </div>
</template>
...
import BojongLioPrintWaModal from '../components/BojongLioPrintWaModal.vue';
import Swal from 'sweetalert2';

const store = useArenaStore();

const isPaperModalOpen = ref(false);
const isBojongLioModalOpen = ref(false);
...
function getDefaultCategoryLevelForAge(age: number): string {
  if (age <= 6) return 'Anak-anak (TK)';
  if (age === 7) return 'Anak-anak (SD Kelas 1)';
  if (age === 8) return 'Anak-anak (SD Kelas 2)';
  if (age === 9) return 'Anak-anak (SD Kelas 3)';
  if (age === 10) return 'Anak-anak (SD Kelas 4)';
  if (age === 11) return 'Anak-anak (SD Kelas 5)';
  if (age === 12) return 'Anak-anak (SD Kelas 6)';
  if (age >= 13 && age <= 15) return 'Remaja (SMP)';
  if (age >= 16 && age <= 18) return 'Remaja (SMA)';
  return 'Dewasa';
}

watch(() => participantForm.age, (newAge) => {
  if (newAge) {
    participantForm.categoryLevel = getDefaultCategoryLevelForAge(newAge);
  }
});
...
const bulkRows = ref<BulkRow[]>([
  { name: '', age: 10, categoryLevel: 'Anak-anak (SD Kelas 4)', gender: 'L', whatsapp: '', address: '', notes: '' },
  { name: '', age: 10, categoryLevel: 'Anak-anak (SD Kelas 4)', gender: 'L', whatsapp: '', address: '', notes: '' },
  { name: '', age: 10, categoryLevel: 'Anak-anak (SD Kelas 4)', gender: 'L', whatsapp: '', address: '', notes: '' },
  { name: '', age: 10, categoryLevel: 'Anak-anak (SD Kelas 4)', gender: 'L', whatsapp: '', address: '', notes: '' },
  { name: '', age: 10, categoryLevel: 'Anak-anak (SD Kelas 4)', gender: 'L', whatsapp: '', address: '', notes: '' }
...
// ---------------------------------------------------------------------
// EDIT & DELETE PARTICIPANT / REGISTRATION LOGIC
// ---------------------------------------------------------------------
...
async function confirmDeleteRegistration(reg: any) {
  const part = store.getParticipantById(reg.participantId);
  const comp = store.getCompetitionById(reg.competitionId);
  const partName = part?.name || 'Peserta';
  const compName = comp?.name || 'Lomba';

  const result = await Swal.fire({
    title: `Hapus Pendaftaran Peserta?`,
    html: `
      <div class="text-left text-xs space-y-2 p-3 bg-red-50 border border-red-200 rounded-xl">
        <div><strong>Nomor Peserta:</strong> <span class="text-red-700 font-mono font-bold">${reg.participantNumber}</span></div>
        <div><strong>Nama Peserta:</strong> ${partName}</div>
        <div><strong>Lomba:</strong> ${compName}</div>
      </div>
      <p class="text-xs text-slate-500 mt-3">Apakah Anda yakin ingin menghapus pendaftaran ini dari sistem?</p>
    `,
    icon: 'warning',
  ...
  if (result.isConfirmed) {
    ...
    Swal.fire({
      ...
      text: `Nomor ${reg.participantNumber} (${partName}) telah dihapus dari sistem.`,
      timer: 1500,
      showConfirmButton: false
    });
  }
