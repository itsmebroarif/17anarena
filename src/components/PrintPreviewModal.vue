<template>
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
    <div class="bg-white text-slate-800 rounded-3xl border border-slate-200 shadow-2xl max-w-5xl w-full max-h-[92vh] flex flex-col overflow-hidden my-auto">
      <!-- Modal Header -->
      <div class="p-5 border-b border-slate-200 flex items-center justify-between bg-white sticky top-0 z-10 no-print">
      ...
      <div class="p-5 bg-slate-50 border-b border-slate-200 space-y-4 no-print">
        <div>
      ...
      <!-- Modal Footer -->
      <div class="p-5 border-t border-slate-200 flex items-center justify-between bg-slate-50 sticky bottom-0 no-print">
        <button
          @click="$emit('close')"
